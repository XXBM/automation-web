package com.xg.hlh.bysj.JpaRepository;
...
public class MyCustomerRepository<T, ID extends Serializable> extends SimpleJpaRepository<T, ID> implements MyRepository<T, ID> {
